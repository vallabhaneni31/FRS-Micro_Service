...
> **Also note**: this spec spans 4 repos and is now centralized at the workspace root `specs/0002-...`
> so all agents and services share the same single source of truth.
